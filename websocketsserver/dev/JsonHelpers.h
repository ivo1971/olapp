...
bool                           GetElementBoolean(const nlohmann::json& jsonData,                   const char* const key);
bool                           GetElementBoolean(const nlohmann::json::const_iterator citJsonData, const char* const key);
